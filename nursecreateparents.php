...
<h4><?php if (isset($_SESSION['user_name'])) echo $_SESSION['user_name']; ?></h4>
        ...
        <div class="main-menu">
          ...
          <h4><i class="fa fa-list-alt" aria-hidden="true"></i><a href="nurseimmunisation.php"> Immunisation Schedule</a>
          </h4>
        </div>
          ...
          <div class="parents-info">
            ...
            <form id="myform" name="form1" method="post" action="">
             ...
             <!-- <label for="">Last Name</label>
              ...
              <input type="tel" id="myform_phone" placeholder="Enter your number" name="phone"
       pattern="[[0-9]{10}"
       required>
              ...
              <button name="submit" 
              onclick="ValidateEmail(document.form1.email)">Add</button>
            </form>
          ...
          <div class="childs-info">
            ...
            <form method='post' action="" name="form2">
              ...
              <button name="add" onclick="validatedate(document.form2.birthday)">Add</button>
            </form>
